...
func generateFromPassword(password string, p *HashConfig) (encodedHash string, err error) {
...
func HashPassword(password string) (string, error) {
	return generateFromPassword(password, DefaultHashConfig)
}

func HashPasswordWithConfig(password string, config *HashConfig) (string, error) {
	return generateFromPassword(password, config)
}
